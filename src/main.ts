...
async function bootstrap() {
  ...
  const html = "<html><head><script src=\"https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.3.0/socket.io.js\"></script><script>function websocketConnect(){const socket = io('http://localhost:"+ port + 
