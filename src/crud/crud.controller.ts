...
export class LocationController {
  ...
  @Post()
  CreateLocation(@Body(ValidationPipe) locationDto: LocationDto, @Request() request){
    if (request.headers["content-type"] !== "application/json")
      throw new BadRequestException("Invalid content type :(");
  ...
  @Put(':id')
  UpdateLocation(@Body(ValidationPipe) locationDto: LocationDto, @Request() request, @Param('id') id: string){
    if (request.headers["content-type"] !== "application/json")
      throw new BadRequestException("Invalid content type :(");
...
export class EquipmentController {
  ...
  @Post()
  CreateEquipment(@Body(ValidationPipe) equipmentDto: EquipmentDto, @Request() request){
    if (request.headers["content-type"] !== "application/json")
      throw new BadRequestException("Invalid content type :(");
  ...
  @Put(':id')
  UpdateEquipment(@Body(ValidationPipe) equipmentDto: EquipmentDto, @Request() request, @Param('id') id: string){
    if (request.headers["content-type"] !== "application/json")
      throw new BadRequestException("Invalid content type :(");
...
export class EmployeeController {
  ...
  @Post()
  CreateEmployee(@Body(ValidationPipe) employeeDto: EmployeeDto, @Request() request){
    if (request.headers["content-type"] !== "application/json")
      throw new BadRequestException("Invalid content type :(");
  ...
  @Put(':id')
  UpdateEmployee(@Body(ValidationPipe) employeeDto: EmployeeDto, @Request() request, @Param('id') id: string){
    if (request.headers["content-type"] !== "application/json")
      throw new BadRequestException("Invalid content type :(");
